...
def pages():
    ...
    pics = {
        ...
        "gdp": cp(os.path.join(ex, "L4_gdp_2048", "countries.png"), "lens_gdp.jpg"), "personyears": cp(os.path.join(ex, "timeline", "L3_personyears_2048", "cartogram.png"), "lens_personyears.jpg"), "lonely": cp(os.path.join(ex, "L6_lonely_2048", "countries.png"), "lens_lonely.jpg"),
    ...
    nav = '<nav><a href="index.html">home</a><a href="flat/">today, zoomable</a><a href="globe/">globe</a><a href="time/">time</a><a href="lenses.html">lenses</a><a href="geometry.html">geometry</a><a href="story.html">tour</a><a href="compare.html">compare</a><a href="../experiments/gallery.html">gallery</a></nav>'
